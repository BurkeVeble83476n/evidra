  ...
  return (
    <>
      <button
        ...
        className="absolute bottom-4 right-4 z-10 inline-flex items-center gap-2 px-4 py-2 bg-accent text-white text-[0.82rem] font-semibold rounded-lg shadow-lg hover:bg-accent-bright transition-colors"
      >
        <svg
          className="w-4 h-4"
          fill="none"
