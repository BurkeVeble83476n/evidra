...
| `actor.skill_version` | Contract version: "1.1.0" |
...
Use prescribe_smart for: kubectl apply/delete/patch, helm install/upgrade, terraform apply/destroy.
Skip for read-only: kubectl get/describe/logs, helm list/status, terraform plan/show.
