...
assert_contains "IngestPrescribeResponse" "cmd/evidra-api/static/openapi.yaml"
assert_contains "IngestReportResponse" "cmd/evidra-api/static/openapi.yaml"
assert_contains "duplicate" "cmd/evidra-api/static/openapi.yaml"
...
assert_contains "flavor" "cmd/evidra-api/static/openapi.yaml"
assert_contains "evidence.kind" "cmd/evidra-api/static/openapi.yaml"
assert_contains "source.system" "cmd/evidra-api/static/openapi.yaml"
...
assert_contains "payload_override" "cmd/evidra-api/static/openapi.yaml"
...
assert_contains "flavor" "docs/guides/self-hosted-setup.md"
assert_contains "evidence.kind" "docs/guides/self-hosted-setup.md"
assert_contains "source.system" "docs/guides/self-hosted-setup.md"
assert_contains "payload.flavor" "docs/guides/self-hosted-setup.md"
assert_contains "payload.evidence.kind" "docs/guides/self-hosted-setup.md"
assert_contains "payload.source.system" "docs/guides/self-hosted-setup.md"

assert_contains "Webhook routes are compatibility wrappers" "docs/ARCHITECTURE.md"
assert_contains "flavor" "docs/ARCHITECTURE.md"
assert_contains "evidence.kind" "docs/ARCHITECTURE.md"
assert_contains "source.system" "docs/ARCHITECTURE.md"
assert_contains "payload.flavor" "docs/ARCHITECTURE.md"
assert_contains "payload.evidence.kind" "docs/ARCHITECTURE.md"
assert_contains "payload.source.system" "docs/ARCHITECTURE.md"

assert_contains "flavor" "docs/system-design/EVIDRA_PROTOCOL_V1.md"
assert_contains "evidence.kind" "docs/system-design/EVIDRA_PROTOCOL_V1.md"
assert_contains "source.system" "docs/system-design/EVIDRA_PROTOCOL_V1.md"
assert_contains "payload.flavor" "docs/system-design/EVIDRA_PROTOCOL_V1.md"
assert_contains "payload.evidence.kind" "docs/system-design/EVIDRA_PROTOCOL_V1.md"
assert_contains "payload.source.system" "docs/system-design/EVIDRA_PROTOCOL_V1.md"

assert_contains "flavor" "docs/system-design/EVIDRA_ARCHITECTURE_V1.md"
assert_contains "evidence.kind" "docs/system-design/EVIDRA_ARCHITECTURE_V1.md"
assert_contains "source.system" "docs/system-design/EVIDRA_ARCHITECTURE_V1.md"
assert_contains "payload.flavor" "docs/system-design/EVIDRA_ARCHITECTURE_V1.md"
assert_contains "payload.evidence.kind" "docs/system-design/EVIDRA_ARCHITECTURE_V1.md"
assert_contains "payload.source.system" "docs/system-design/EVIDRA_ARCHITECTURE_V1.md"
