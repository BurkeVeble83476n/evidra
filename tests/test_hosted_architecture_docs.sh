...
assert_contains "/v1/evidence/scorecard" "docs/system-design/EVIDRA_ARCHITECTURE_V1.md"
assert_contains "prescribe_full" "docs/system-design/EVIDRA_ARCHITECTURE_V1.md"
assert_not_contains "/assess" "docs/system-design/EVIDRA_ARCHITECTURE_V1.md"
assert_not_contains "LLM Layer" "docs/system-design/EVIDRA_ARCHITECTURE_V1.md"
assert_not_contains "COMMUNITY_BENCHMARK_DESIGN" "docs/system-design/EVIDRA_ARCHITECTURE_V1.md"
assert_not_contains "DATASET_ARCHITECTURE" "docs/system-design/EVIDRA_ARCHITECTURE_V1.md"
assert_not_contains "EXPERIMENT_DESIGN" "docs/system-design/EVIDRA_ARCHITECTURE_V1.md"
assert_not_contains "FAULT_INJECTION_RUNBOOK" "docs/system-design/EVIDRA_ARCHITECTURE_V1.md"
assert_not_contains "LLM_RISK_PREDICTION_CONTRACT" "docs/system-design/EVIDRA_ARCHITECTURE_V1.md"
