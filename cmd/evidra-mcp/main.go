...
func printHelp(w io.Writer) {
	...
	fmt.Fprintln(w, "  Direct (default)  run_command, collect_diagnostics, write_file, prescribe_smart, report, get_event")
	...
	fmt.Fprintln(w, "  prescribe_smart  Record lightweight target intent BEFORE execution (returns risk + prescription_id)")
